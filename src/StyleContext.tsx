...
export interface StyleContextProps {
  ...
  linters?: Linter[];
  /**
   * Reuse style generated by SSR.
   * By default `@ant-design/cssinjs` will clean all the style from server side
   * and regenerate style in client side to avoid SSR style not match.
   * Enable this option will skip the clean step and reuse the style from server side including css file.
   */
  recycling?: boolean;
}
